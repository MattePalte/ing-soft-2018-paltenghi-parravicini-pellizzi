...
public class LocalViewCli extends UnicastRemoteObject implements IView, IEventHandler, Serializable {
    ...
    public LocalViewCli(String ownerNameOfTheView, IController controller) throws RemoteException {
