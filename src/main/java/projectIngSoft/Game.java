...
public class Game {
    ...
    */
    public Game(int theNumOfPlayer) {
        ...
        while (publicObjectives.size() > 3) publicObjectives.remove(0);
    }
    ...
    */
    ...
    public void setupPhase(){
        for (Player p : players) {
            ...
            System.out.println("To " + p.getName() + " has been given : " + p.getMyPrivateObjective().getDescription());
        }
